...
ol.contract-decimal-list > li::before { content: counter(clause-decimal, decimal) '.'; position: absolute; left: 0; width: 1.85em; text-align: right; font-weight: 700; }
    ...
    <li>{{nama_pemberi_sewa}}, pemilik KTP dengan nomor {{ktp_pemberi_sewa}} bertempat tinggal permanen di {{alamat_pemberi_sewa}} , untuk selanjutnya disebut “Pemberi Sewa”; dan</li>
    <li>{{nama_penyewa}}, pemilik KTP dengan nomor {{ktp_penyewa}} bertempat tinggal permanen di {{alamat_penyewa}}, untuk selanjutnya disebut “Penyewa”,</li>
    </ol>
    ...
    <ol class="contract-decimal-list">
    <li>Bahwa, Pemberi Sewa adalah pemilik yang sah atas suatu tempat yang berdiri di atas tanah hak atas tanah milik dengan Sertifikat Hak Milik (SHM) Nomor: {{nomor_shm}} atas nama {{nama_pemilik_shm}} yang setempat dikenal sebagai {{alamat_lengkap_tempat}} (selanjutnya disebut “Tempat”).</li>
...
const FLOW_BASE_PATH = '/templates/sewa-menyewa';
